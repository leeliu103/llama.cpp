...
static __global__ void mul_mat_vec_q(
        ...
        const uint32_t ids_stride, const uint32_t mxfp4_q_offset) {
...
static void mul_mat_vec_q_switch_fusion(
        ...
        const uint32_t ids_stride, const uint32_t mxfp4_q_offset, cudaStream_t stream) {
...
static void mul_mat_vec_q_switch_ncols_dst(
        ...
        const int ids_stride,  const uint32_t mxfp4_q_offset, cudaStream_t stream) {
...
void ggml_cuda_mul_mat_vec_q(
    ...
    const int64_t s11 = src0->type == GGML_TYPE_MXFP4
        ? (ne10_padded / (4 * QK8_1))
        : (ne10_padded / QK8_1);    const int64_t s1  =  dst->nb[1] / ts_dst;
