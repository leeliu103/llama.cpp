...
static __device__ __forceinline__ void accumulate_q4_K_q8_1_x4_iter(
        ...
        const int kby, const int kbx, const int kqs,
...
static __global__ void mul_mat_vec_q4_K_q8_1_x4(
    ...
    for (; kbx + blocks_per_iter < blocks_per_row_x; kbx += 2*blocks_per_iter, kby += 2*kby_step) {
        accumulate_q4_K_q8_1_x4_iter<has_gate_fusion>(vx_row, vgate_row, y_row, kby, kbx, kqs, tmp, tmp_gate);
        accumulate_q4_K_q8_1_x4_iter<has_gate_fusion>(vx_row, vgate_row, y_row, kby + kby_step, kbx + blocks_per_iter, kqs, tmp, tmp_gate);
    }
...
void ggml_cuda_mul_mat_vec_q(
    ...
    const int64_t s11 = use_q4_K_q8_1_x4 ? ne10_padded / (4 * QK8_1) : ne10_padded / QK8_1;
    ...
    if (use_q4_K_q8_1_x4) {
        ...
        dispatch_mul_mat_vec_q4_K_q8_1_x4(
            src0->data, src1_q8_1.get(), ids_d, fusion_local, dst_d, (uint32_t) ne00,
