...
typedef size_t (*ggml_backend_tensor_alloc_size_callback)(const struct ggml_tensor * tensor);
...
GGML_API struct ggml_backend_buffer * ggml_backend_alloc_ctx_tensors_from_buft_ext(
